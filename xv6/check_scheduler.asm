 ...
 168:	89 f3                	mov    %esi,%ebx
{
 ...
 180:	50                   	push   %eax
 181:	6a 00                	push   $0x0
 183:	e8 42 01 00 00       	call   2ca <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1ed:	e8 00 01 00 00       	call   2f2 <open>
  if(fd < 0)
 ...
 201:	50                   	push   %eax
 202:	e8 03 01 00 00       	call   30a <fstat>
  close(fd);
 207:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 20a:	89 c6                	mov    %eax,%esi
  close(fd);
 20c:	e8 c9 00 00 00       	call   2da <close>
  return r;
...
000002ba <getpinfo>:
SYSCALL(getpinfo)
 2ba:	b8 18 00 00 00       	mov    $0x18,%eax
 2bf:	cd 40                	int    $0x40
 2c1:	c3                   	ret    
