...
int main(int argc, char *argv[])
{
  ...
  23:	74 0e                	je     33 <main+0x33>
  {
    int pid = fork();
  25:	e8 80 02 00 00       	call   2aa <fork>
  ...
  exit();
  2e:	e8 7f 02 00 00       	call   2b2 <exit>
    wait();
  33:	e8 82 02 00 00       	call   2ba <wait>
  38:	e8 7d 02 00 00       	call   2ba <wait>
  3d:	e8 78 02 00 00       	call   2ba <wait>
  42:	e8 73 02 00 00       	call   2ba <wait>
  47:	e8 6e 02 00 00       	call   2ba <wait>
  4c:	e8 69 02 00 00       	call   2ba <wait>
  51:	eb db                	jmp    2e <main+0x2e>
  53:	66 90                	xchg   %ax,%ax
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
 ...
 178:	89 f3                	mov    %esi,%ebx
{
 ...
 190:	50                   	push   %eax
 191:	6a 00                	push   $0x0
 193:	e8 3a 01 00 00       	call   2d2 <read>
    if(cc < 1)
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3e0:	e8 f5 fe ff ff       	call   2da <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 450:	e8 85 fe ff ff       	call   2da <write>
 ...
 4b1:	e8 24 fe ff ff       	call   2da <write>
 ...
 4c8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ca:	e8 0b fe ff ff       	call   2da <write>
  for(i = 0; fmt[i]; i++){
 ...
 563:	57                   	push   %edi
 564:	53                   	push   %ebx
 565:	e8 70 fd ff ff       	call   2da <write>
        while(*s != 0){
 ...
 5b7:	e8 1e fd ff ff       	call   2da <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6ce:	56                   	push   %esi
 6cf:	e8 6e fc ff ff       	call   342 <sbrk>
  if(p == (char*)-1)
