...
_check_scheduler:     file format elf32-i386
...
int main(int argc, char *argv[])
{
   ...
   d:	53                   	push   %ebx
   e:	51                   	push   %ecx
   f:	bb 06 00 00 00       	mov    $0x6,%ebx
  for(int i = 0; i < 6; i++)
  {
    int pid = fork();
  14:	e8 81 02 00 00       	call   29a <fork>

    if(pid == 0)
  19:	85 c0                	test   %eax,%eax
  1b:	74 23                	je     40 <main+0x40>
  for(int i = 0; i < 6; i++)
  ...
  {
    wait();
  22:	e8 83 02 00 00       	call   2aa <wait>
  27:	e8 7e 02 00 00       	call   2aa <wait>
  2c:	e8 79 02 00 00       	call   2aa <wait>
  31:	e8 74 02 00 00       	call   2aa <wait>
  36:	e8 6f 02 00 00       	call   2aa <wait>
  3b:	e8 6a 02 00 00       	call   2aa <wait>
  }
  exit();
 ...
 168:	89 f3                	mov    %esi,%ebx
{
 ...
 180:	50                   	push   %eax
 181:	6a 00                	push   $0x0
 183:	e8 3a 01 00 00       	call   2c2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1ed:	e8 f8 00 00 00       	call   2ea <open>
  if(fd < 0)
 ...
 201:	50                   	push   %eax
 202:	e8 fb 00 00 00       	call   302 <fstat>
  close(fd);
 207:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 20a:	89 c6                	mov    %eax,%esi
  close(fd);
 20c:	e8 c1 00 00 00       	call   2d2 <close>
  return r;
 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 3d0:	e8 f5 fe ff ff       	call   2ca <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 440:	e8 85 fe ff ff       	call   2ca <write>
 ...
 4a1:	e8 24 fe ff ff       	call   2ca <write>
 ...
 4b8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ba:	e8 0b fe ff ff       	call   2ca <write>
  for(i = 0; fmt[i]; i++){
 ...
 553:	57                   	push   %edi
 554:	53                   	push   %ebx
 555:	e8 70 fd ff ff       	call   2ca <write>
        while(*s != 0){
 ...
 5a7:	e8 1e fd ff ff       	call   2ca <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6be:	56                   	push   %esi
 6bf:	e8 6e fc ff ff       	call   332 <sbrk>
  if(p == (char*)-1)
