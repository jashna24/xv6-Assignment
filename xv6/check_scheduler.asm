...
int main(int argc, char *argv[])
{
  ...
  31:	6a 14                	push   $0x14
  33:	e8 22 03 00 00       	call   35a <sleep>
      {
  ...
  3d:	bb 64 00 00 00       	mov    $0x64,%ebx
  ...
  {
    wait();
  48:	e8 6d 02 00 00       	call   2ba <wait>
  for(int i = 0; i < 100; i++)
  4d:	83 eb 01             	sub    $0x1,%ebx
  50:	75 f6                	jne    48 <main+0x48>
  }
  exit();
  52:	e8 5b 02 00 00       	call   2b2 <exit>
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
...
000002ca <getpinfo>:
SYSCALL(getpinfo)
 2ca:	b8 18 00 00 00       	mov    $0x18,%eax
 2cf:	cd 40                	int    $0x40
 2d1:	c3                   	ret    
