...
int main(int argc, char *argv[])
{
  ...
  25:	89 85 14 ff ff ff    	mov    %eax,-0xec(%ebp)
	...
	pid = fork();
  2b:	e8 2a 03 00 00       	call   35a <fork>
  ...
  7b:	75 eb                	jne    68 <main+0x68>
	...
	if(pid==0)
  7d:	8b b5 10 ff ff ff    	mov    -0xf0(%ebp),%esi
	com[argc-1] = 0;
  ...
  a7:	e8 f6 02 00 00       	call   3a2 <exec>
  ...
  be:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  c1:	e8 9c 02 00 00       	call   362 <exit>
		printf(1,"%d\n",pid);
  c6:	50                   	push   %eax
  c7:	ff b5 10 ff ff ff    	pushl  -0xf0(%ebp)
  cd:	68 18 08 00 00       	push   $0x818
  d2:	6a 01                	push   $0x1
  d4:	e8 d7 03 00 00       	call   4b0 <printf>
		status = waitx(&wait_time, &run_time);
  d9:	8d 85 18 ff ff ff    	lea    -0xe8(%ebp),%eax
  df:	5a                   	pop    %edx
  e0:	59                   	pop    %ecx
  e1:	50                   	push   %eax
  e2:	8d 85 1c ff ff ff    	lea    -0xe4(%ebp),%eax
  e8:	50                   	push   %eax
  e9:	e8 84 02 00 00       	call   372 <waitx>
		printf(1,"run time: %d, wait time: %d and status: %d\n",run_time,wait_time,status);
  ee:	89 04 24             	mov    %eax,(%esp)
  f1:	ff b5 1c ff ff ff    	pushl  -0xe4(%ebp)
  f7:	ff b5 18 ff ff ff    	pushl  -0xe8(%ebp)
  fd:	68 1c 08 00 00       	push   $0x81c
 102:	6a 01                	push   $0x1
 104:	e8 a7 03 00 00       	call   4b0 <printf>
 109:	83 c4 20             	add    $0x20,%esp
 10c:	eb b3                	jmp    c1 <main+0xc1>
 ...
 228:	89 f3                	mov    %esi,%ebx
{
 ...
 240:	50                   	push   %eax
 241:	6a 00                	push   $0x0
 243:	e8 3a 01 00 00       	call   382 <read>
    if(cc < 1)
 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 480:	e8 05 ff ff ff       	call   38a <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4f0:	e8 95 fe ff ff       	call   38a <write>
 ...
 551:	e8 34 fe ff ff       	call   38a <write>
 ...
 568:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 56a:	e8 1b fe ff ff       	call   38a <write>
  for(i = 0; fmt[i]; i++){
 ...
 603:	57                   	push   %edi
 604:	53                   	push   %ebx
 605:	e8 80 fd ff ff       	call   38a <write>
        while(*s != 0){
 ...
 657:	e8 2e fd ff ff       	call   38a <write>
        ap++;
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 48 08 00 00       	mov    $0x848,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 76e:	56                   	push   %esi
 76f:	e8 7e fc ff ff       	call   3f2 <sbrk>
  if(p == (char*)-1)
