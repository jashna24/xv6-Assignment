...
int main(int argc, char *argv[])
{
  ...
  43:	83 c6 04             	add    $0x4,%esi
  46:	6a 64                	push   $0x64
  48:	e8 b3 06 00 00       	call   700 <malloc>
  4d:	89 46 fc             	mov    %eax,-0x4(%esi)
	for(int i=0;i<50;i++)
  ...
  a7:	e8 e6 02 00 00       	call   392 <exec>
    	printf(1, "exec %s failed\n", argv[1]);
  ac:	83 c4 0c             	add    $0xc,%esp
  af:	ff 77 04             	pushl  0x4(%edi)
  b2:	68 f8 07 00 00       	push   $0x7f8
  b7:	6a 01                	push   $0x1
  ...
  de:	ff b5 1c ff ff ff    	pushl  -0xe4(%ebp)
  e4:	ff b5 18 ff ff ff    	pushl  -0xe8(%ebp)
  ea:	68 08 08 00 00       	push   $0x808
  ef:	6a 01                	push   $0x1
  f1:	e8 aa 03 00 00       	call   4a0 <printf>
  f6:	83 c4 20             	add    $0x20,%esp
  f9:	eb c6                	jmp    c1 <main+0xc1>
  fb:	66 90                	xchg   %ax,%ax
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop
 ...
 409:	85 d2                	test   %edx,%edx
{
 ...
 437:	f7 f1                	div    %ecx
 439:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 34 08 00 00       	mov    $0x834,%ebx
        while(*s != 0){
 ...
 671:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 ...
 6c6:	72 ce                	jb     696 <free+0x26>
{
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 ec 0a 00 00       	mov    %eax,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 ec 0a 00 00    	cmp    %eax,0xaec
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 7a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 ec 0a 00 00    	mov    %edx,0xaec
}
 ...
 7b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 7c7:	0a 00 00 
 7ca:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 7d1:	0a 00 00 
    base.s.size = 0;
 7d4:	b8 f0 0a 00 00       	mov    $0xaf0,%eax
 7d9:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 7e0:	00 00 00 
