...
int main()
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
    int w,r,ret;
    if(fork()==0)
  14:	e8 f1 02 00 00       	call   30a <fork>
  19:	85 c0                	test   %eax,%eax
  1b:	75 44                	jne    61 <main+0x61>
  1d:	89 c3                	mov    %eax,%ebx
    {
        for(int i=0;i<4;i++)
        {
            int p=fork();
  1f:	e8 e6 02 00 00       	call   30a <fork>
            if(p==0)
  24:	85 c0                	test   %eax,%eax
  26:	74 61                	je     89 <main+0x89>
        for(int i=0;i<4;i++)
  28:	83 c3 01             	add    $0x1,%ebx
  2b:	83 fb 04             	cmp    $0x4,%ebx
  2e:	75 ef                	jne    1f <main+0x1f>
  30:	8d 7d e4             	lea    -0x1c(%ebp),%edi
  33:	8d 75 e0             	lea    -0x20(%ebp),%esi
                exit();
            }
        }
        for(int i=0; i<4;i++)
  ...
  39:	57                   	push   %edi
  3a:	56                   	push   %esi
  3b:	e8 e2 02 00 00       	call   322 <waitx>
            printf(1,"pid-%d rtime-%d wtime-%d\n",ret,r,w);
  40:	59                   	pop    %ecx
  41:	ff 75 e0             	pushl  -0x20(%ebp)
  44:	ff 75 e4             	pushl  -0x1c(%ebp)
  47:	50                   	push   %eax
  48:	68 d6 07 00 00       	push   $0x7d6
  4d:	6a 01                	push   $0x1
  4f:	e8 1c 04 00 00       	call   470 <printf>
        for(int i=0; i<4;i++)
  54:	83 c4 20             	add    $0x20,%esp
  57:	83 eb 01             	sub    $0x1,%ebx
  5a:	75 da                	jne    36 <main+0x36>
        }
        exit();
    }
    ret=waitx(&w,&r);
    ...
    exit();
  5c:	e8 b1 02 00 00       	call   312 <exit>
    ret=waitx(&w,&r);
  61:	50                   	push   %eax
  62:	50                   	push   %eax
  ...
  6a:	50                   	push   %eax
  6b:	e8 b2 02 00 00       	call   322 <waitx>
    printf(1,"parent proc:- pid-%d rtime-%d wtime-%d\n",ret,w,r);
  70:	5a                   	pop    %edx
  71:	ff 75 e4             	pushl  -0x1c(%ebp)
  74:	ff 75 e0             	pushl  -0x20(%ebp)
  77:	50                   	push   %eax
  78:	68 f0 07 00 00       	push   $0x7f0
  7d:	6a 01                	push   $0x1
  7f:	e8 ec 03 00 00       	call   470 <printf>
    exit();
  84:	83 c4 20             	add    $0x20,%esp
  87:	eb d3                	jmp    5c <main+0x5c>
                printf(1,"proc %d.... \n",i);
  89:	56                   	push   %esi
  8a:	53                   	push   %ebx
  8b:	bb 81 96 98 00       	mov    $0x989681,%ebx
  90:	68 c8 07 00 00       	push   $0x7c8
  95:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	e9 8f fe ff ff       	jmp    4b8 <printf+0x48>
          s = "(null)";
 629:	bb 18 08 00 00       	mov    $0x818,%ebx
        while(*s != 0){
