...
_chngpr:     file format elf32-i386
  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  61:	50                   	push   %eax
  62:	56                   	push   %esi
  63:	e8 22 03 00 00       	call   38a <set_priority>
	if(old_pid == -1)
  ...
  70:	52                   	push   %edx
  71:	50                   	push   %eax
  72:	68 0d 08 00 00       	push   $0x80d
  77:	6a 02                	push   $0x2
  79:	e8 d2 03 00 00       	call   450 <printf>
  7e:	83 c4 10             	add    $0x10,%esp
	exit();
  81:	e8 6c 02 00 00       	call   2f2 <exit>
		printf(2,"Pid does not exists\n");
  86:	51                   	push   %ecx
  87:	51                   	push   %ecx
  88:	68 f8 07 00 00       	push   $0x7f8
  8d:	6a 02                	push   $0x2
  8f:	e8 bc 03 00 00       	call   450 <printf>
  94:	83 c4 10             	add    $0x10,%esp
  97:	eb e8                	jmp    81 <main+0x81>
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
  9d:	66 90                	xchg   %ax,%ax
  9f:	90                   	nop
 ...
 1b8:	89 f3                	mov    %esi,%ebx
{
 ...
 1d0:	50                   	push   %eax
 1d1:	6a 00                	push   $0x0
 1d3:	e8 3a 01 00 00       	call   312 <read>
    if(cc < 1)
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 28 08 00 00 	movzbl 0x828(%edx),%edx
  }while((x /= base) != 0);
 ...
 420:	e8 f5 fe ff ff       	call   31a <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 490:	e8 85 fe ff ff       	call   31a <write>
 ...
 4f1:	e8 24 fe ff ff       	call   31a <write>
 ...
 508:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 50a:	e8 0b fe ff ff       	call   31a <write>
  for(i = 0; fmt[i]; i++){
 ...
 5a3:	57                   	push   %edi
 5a4:	53                   	push   %ebx
 5a5:	e8 70 fd ff ff       	call   31a <write>
        while(*s != 0){
 ...
 5f7:	e8 1e fd ff ff       	call   31a <write>
        ap++;
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 1f 08 00 00       	mov    $0x81f,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 70e:	56                   	push   %esi
 70f:	e8 6e fc ff ff       	call   382 <sbrk>
  if(p == (char*)-1)
