 ...
 148:	89 f3                	mov    %esi,%ebx
{
 ...
 160:	50                   	push   %eax
 161:	6a 00                	push   $0x0
 163:	e8 3a 01 00 00       	call   2a2 <read>
    if(cc < 1)
 ...
 349:	85 d2                	test   %edx,%edx
{
 ...
 3b0:	e8 f5 fe ff ff       	call   2aa <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 420:	e8 85 fe ff ff       	call   2aa <write>
 ...
 481:	e8 24 fe ff ff       	call   2aa <write>
 ...
 498:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 49a:	e8 0b fe ff ff       	call   2aa <write>
  for(i = 0; fmt[i]; i++){
 ...
 533:	57                   	push   %edi
 534:	53                   	push   %ebx
 535:	e8 70 fd ff ff       	call   2aa <write>
        while(*s != 0){
 ...
 587:	e8 1e fd ff ff       	call   2aa <write>
        ap++;
 ...
 594:	e9 8f fe ff ff       	jmp    428 <printf+0x48>
          s = "(null)";
 599:	bb 3a 07 00 00       	mov    $0x73a,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 e8 09 00 00       	mov    0x9e8,%eax
{
 ...
 5ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ef:	a3 e8 09 00 00       	mov    %eax,0x9e8
}
 5f4:	5b                   	pop    %ebx
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 e8 09 00 00    	mov    0x9e8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69e:	56                   	push   %esi
 69f:	e8 6e fc ff ff       	call   312 <sbrk>
  if(p == (char*)-1)
 ...
 6e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6e7:	89 15 e8 09 00 00    	mov    %edx,0x9e8
}
 ...
 6f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 e8 09 00 00 ec 	movl   $0x9ec,0x9e8
 707:	09 00 00 
 70a:	c7 05 ec 09 00 00 ec 	movl   $0x9ec,0x9ec
 711:	09 00 00 
    base.s.size = 0;
 714:	b8 ec 09 00 00       	mov    $0x9ec,%eax
 719:	c7 05 f0 09 00 00 00 	movl   $0x0,0x9f0
 720:	00 00 00 
