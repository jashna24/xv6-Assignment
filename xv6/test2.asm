...
int main()
{
  ...
  2d:	75 e9                	jne    18 <main+0x18>
	...
	exit();
  2f:	e8 5e 02 00 00       	call   292 <exit>
  34:	66 90                	xchg   %ax,%ax
  36:	66 90                	xchg   %ax,%ax
  38:	66 90                	xchg   %ax,%ax
  3a:	66 90                	xchg   %ax,%ax
 ...
 158:	89 f3                	mov    %esi,%ebx
{
 ...
 170:	50                   	push   %eax
 171:	6a 00                	push   $0x0
 173:	e8 3a 01 00 00       	call   2b2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1dd:	e8 f8 00 00 00       	call   2da <open>
  if(fd < 0)
 ...
 1f1:	50                   	push   %eax
 1f2:	e8 fb 00 00 00       	call   2f2 <fstat>
  close(fd);
 1f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1fa:	89 c6                	mov    %eax,%esi
  close(fd);
 1fc:	e8 c1 00 00 00       	call   2c2 <close>
  return r;
 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 3c0:	e8 f5 fe ff ff       	call   2ba <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 430:	e8 85 fe ff ff       	call   2ba <write>
 ...
 491:	e8 24 fe ff ff       	call   2ba <write>
 ...
 4a8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4aa:	e8 0b fe ff ff       	call   2ba <write>
  for(i = 0; fmt[i]; i++){
 ...
 543:	57                   	push   %edi
 544:	53                   	push   %ebx
 545:	e8 70 fd ff ff       	call   2ba <write>
        while(*s != 0){
 ...
 597:	e8 1e fd ff ff       	call   2ba <write>
        ap++;
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 4a 07 00 00       	mov    $0x74a,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6ae:	56                   	push   %esi
 6af:	e8 6e fc ff ff       	call   322 <sbrk>
  if(p == (char*)-1)
