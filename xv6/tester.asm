...
int main(int argc, char *argv[]){
  ...
  2b:	39 f3                	cmp    %esi,%ebx
  2d:	7d 2a                	jge    59 <main+0x59>
            ppid = fork();
  ...
  60:	83 c3 01             	add    $0x1,%ebx
            wait();
  63:	e8 a2 02 00 00       	call   30a <wait>
        for(int i = 0; i < child; i++){
  68:	39 f3                	cmp    %esi,%ebx
  6a:	75 f4                	jne    60 <main+0x60>
                exit();
  6c:	e8 91 02 00 00       	call   302 <exit>
        child = atoi(argv[1]);
  71:	83 ec 0c             	sub    $0xc,%esp
  74:	ff 70 04             	pushl  0x4(%eax)
  77:	e8 14 02 00 00       	call   290 <atoi>
        for(int j = 0; j < child; j++){
  ...
  90:	d8 05 cc 07 00 00    	fadds  0x7cc
  96:	d9 05 d0 07 00 00    	flds   0x7d0
  9c:	df e9                	fucomip %st(1),%st
  9e:	77 f0                	ja     90 <main+0x90>
  a0:	dd d8                	fstp   %st(0)
  a2:	eb c8                	jmp    6c <main+0x6c>
  a4:	66 90                	xchg   %ax,%ax
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 3f7:	f7 f1                	div    %ecx
 3f9:	0f b6 92 dc 07 00 00 	movzbl 0x7dc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb d4 07 00 00       	mov    $0x7d4,%ebx
        while(*s != 0){
 ...
 631:	a1 88 0a 00 00       	mov    0xa88,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 88 0a 00 00       	mov    %eax,0xa88
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 88 0a 00 00    	mov    0xa88,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 47                	jae    758 <malloc+0x98>
    ...
    if(p == freep)
 711:	39 05 88 0a 00 00    	cmp    %eax,0xa88
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 88 0a 00 00    	mov    0xa88,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 88 0a 00 00    	mov    %edx,0xa88
}
 ...
 787:	0a 00 00 
 78a:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 8c 0a 00 00       	mov    $0xa8c,%eax
 799:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 7a0:	00 00 00 
