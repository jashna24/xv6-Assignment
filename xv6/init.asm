...
main(void)
{
  ...
  17:	6a 01                	push   $0x1
  19:	e8 82 04 00 00       	call   4a0 <printf>
  int pid, wpid;
  ...
  1f:	5a                   	pop    %edx
  20:	6a 02                	push   $0x2
  22:	68 fd 07 00 00       	push   $0x7fd
  27:	e8 6e 03 00 00       	call   39a <open>
  2c:	83 c4 10             	add    $0x10,%esp
  2f:	85 c0                	test   %eax,%eax
  31:	0f 88 a1 00 00 00    	js     d8 <main+0xd8>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  3a:	6a 00                	push   $0x0
  3c:	e8 91 03 00 00       	call   3d2 <dup>
  dup(0);  // stderr
  41:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  48:	e8 85 03 00 00       	call   3d2 <dup>
  ...
  b4:	50                   	push   %eax
  b5:	50                   	push   %eax
  b6:	68 14 0b 00 00       	push   $0xb14
  bb:	68 43 08 00 00       	push   $0x843
  c0:	e8 cd 02 00 00       	call   392 <exec>
      printf(1, "init: exec sh failed\n");
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  c7:	68 46 08 00 00       	push   $0x846
  cc:	6a 01                	push   $0x1
  ...
  d9:	6a 01                	push   $0x1
  db:	6a 01                	push   $0x1
  dd:	68 fd 07 00 00       	push   $0x7fd
  e2:	e8 bb 02 00 00       	call   3a2 <mknod>
    open("console", O_RDWR);
  e7:	5b                   	pop    %ebx
  e8:	58                   	pop    %eax
  e9:	6a 02                	push   $0x2
  eb:	68 fd 07 00 00       	push   $0x7fd
  f0:	e8 a5 02 00 00       	call   39a <open>
  f5:	83 c4 10             	add    $0x10,%esp
  f8:	e9 3a ff ff ff       	jmp    37 <main+0x37>
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop
 ...
 218:	89 f3                	mov    %esi,%ebx
{
 ...
 230:	50                   	push   %eax
 231:	6a 00                	push   $0x0
 233:	e8 3a 01 00 00       	call   372 <read>
    if(cc < 1)
 ...
 409:	85 d2                	test   %edx,%edx
{
 ...
 470:	e8 05 ff ff ff       	call   37a <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4e0:	e8 95 fe ff ff       	call   37a <write>
 ...
 541:	e8 34 fe ff ff       	call   37a <write>
 ...
 558:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 55a:	e8 1b fe ff ff       	call   37a <write>
  for(i = 0; fmt[i]; i++){
 ...
 5f3:	57                   	push   %edi
 5f4:	53                   	push   %ebx
 5f5:	e8 80 fd ff ff       	call   37a <write>
        while(*s != 0){
 ...
 647:	e8 2e fd ff ff       	call   37a <write>
        ap++;
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 65 08 00 00       	mov    $0x865,%ebx
        while(*s != 0){
 ...
 671:	a1 1c 0b 00 00       	mov    0xb1c,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 1c 0b 00 00    	cmp    %eax,0xb1c
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 1c 0b 00 00    	mov    0xb1c,%edx
 ...
 7a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
}
 ...
 7b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 1c 0b 00 00 20 	movl   $0xb20,0xb1c
 7c7:	0b 00 00 
 7ca:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 7d1:	0b 00 00 
    base.s.size = 0;
 7d4:	b8 20 0b 00 00       	mov    $0xb20,%eax
 7d9:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 7e0:	00 00 00 
