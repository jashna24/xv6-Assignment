  ...
  11:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  22:	e8 19 04 00 00       	call   440 <printf>
		exit();
  27:	e8 b6 02 00 00       	call   2e2 <exit>
	}
  ...
  2f:	ff 70 04             	pushl  0x4(%eax)
  32:	e8 39 02 00 00       	call   270 <atoi>
	getpinfo(&p, pid);
  37:	59                   	pop    %ecx
  38:	5a                   	pop    %edx
  39:	50                   	push   %eax
  3a:	8d 45 d4             	lea    -0x2c(%ebp),%eax
  3d:	50                   	push   %eax
  3e:	e8 b7 02 00 00       	call   2fa <getpinfo>
	if(p.pid !=-1)
  43:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  ...
  58:	ff 75 e8             	pushl  -0x18(%ebp)
  5b:	ff 75 e4             	pushl  -0x1c(%ebp)
  5e:	ff 75 e0             	pushl  -0x20(%ebp)
  61:	ff 75 dc             	pushl  -0x24(%ebp)
  64:	ff 75 d8             	pushl  -0x28(%ebp)
  67:	50                   	push   %eax
  68:	68 c4 07 00 00       	push   $0x7c4
  6d:	6a 01                	push   $0x1
  6f:	e8 cc 03 00 00       	call   440 <printf>
  74:	83 c4 30             	add    $0x30,%esp
	{
	...
	exit();
  77:	e8 66 02 00 00       	call   2e2 <exit>
		printf(1,"pid not found\n");
  7c:	50                   	push   %eax
  7d:	50                   	push   %eax
  7e:	68 0c 08 00 00       	push   $0x80c
  83:	6a 01                	push   $0x1
  85:	e8 b6 03 00 00       	call   440 <printf>
  8a:	83 c4 10             	add    $0x10,%esp
  8d:	eb e8                	jmp    77 <main+0x77>
  8f:	90                   	nop
 ...
 1a8:	89 f3                	mov    %esi,%ebx
{
 ...
 1c0:	50                   	push   %eax
 1c1:	6a 00                	push   $0x0
 1c3:	e8 42 01 00 00       	call   30a <read>
    if(cc < 1)
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 24 08 00 00 	movzbl 0x824(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 1b 08 00 00       	mov    $0x81b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 c8 0a 00 00       	mov    %eax,0xac8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 c8 0a 00 00    	cmp    %eax,0xac8
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 c8 0a 00 00 cc 	movl   $0xacc,0xac8
 767:	0a 00 00 
 76a:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 cc 0a 00 00       	mov    $0xacc,%eax
 779:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 780:	00 00 00 
