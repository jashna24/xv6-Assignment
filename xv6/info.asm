...
{	
  ...
  17:	e8 44 02 00 00       	call   260 <atoi>
	getpinfo(&p, pid);
  1c:	59                   	pop    %ecx
  1d:	5a                   	pop    %edx
  1e:	50                   	push   %eax
  ...
  22:	50                   	push   %eax
  23:	e8 c2 02 00 00       	call   2ea <getpinfo>
	if(p.pid !=-1)
  28:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  2b:	83 c4 10             	add    $0x10,%esp
  2e:	83 f8 ff             	cmp    $0xffffffff,%eax
  31:	74 2e                	je     61 <main+0x61>
  ...
  3d:	ff 75 e8             	pushl  -0x18(%ebp)
  40:	ff 75 e4             	pushl  -0x1c(%ebp)
  43:	ff 75 e0             	pushl  -0x20(%ebp)
  46:	ff 75 dc             	pushl  -0x24(%ebp)
  49:	ff 75 d8             	pushl  -0x28(%ebp)
  4c:	50                   	push   %eax
  4d:	68 88 07 00 00       	push   $0x788
  52:	6a 01                	push   $0x1
  54:	e8 d7 03 00 00       	call   430 <printf>
  59:	83 c4 30             	add    $0x30,%esp
	{
  ...
  61:	50                   	push   %eax
  62:	50                   	push   %eax
  63:	68 d0 07 00 00       	push   $0x7d0
  68:	6a 01                	push   $0x1
  6a:	e8 c1 03 00 00       	call   430 <printf>
  6f:	83 c4 10             	add    $0x10,%esp
  72:	eb e8                	jmp    5c <main+0x5c>
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb df 07 00 00       	mov    $0x7df,%ebx
        while(*s != 0){
