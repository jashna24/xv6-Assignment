...
int main(int argc, char *argv[]) {
   ...
   f:	bb 08 00 00 00       	mov    $0x8,%ebx
    ...
    for (int k = 0; k < n; k++) {
        id = fork();
  14:	e8 c1 02 00 00       	call   2da <fork>
        if (id < 0) {
  19:	85 c0                	test   %eax,%eax
  1b:	78 3b                	js     58 <main+0x58>
            printf(1, "%d failed in fork!\n", getpid());
        }
        if (id == 0) {  // child
  1d:	74 53                	je     72 <main+0x72>
    for (int k = 0; k < n; k++) {
  ...
  22:	75 f0                	jne    14 <main+0x14>
    ...
    for (int k = 0; k < n; k++) {
        wait();
  24:	e8 c1 02 00 00       	call   2ea <wait>
  29:	e8 bc 02 00 00       	call   2ea <wait>
  2e:	e8 b7 02 00 00       	call   2ea <wait>
  33:	e8 b2 02 00 00       	call   2ea <wait>
  38:	e8 ad 02 00 00       	call   2ea <wait>
  3d:	e8 a8 02 00 00       	call   2ea <wait>
  42:	e8 a3 02 00 00       	call   2ea <wait>
  47:	e8 9e 02 00 00       	call   2ea <wait>
            exit();
  4c:	e8 91 02 00 00       	call   2e2 <exit>
  51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            printf(1, "%d failed in fork!\n", getpid());
  58:	e8 15 03 00 00       	call   372 <getpid>
  ...
  70:	eb ad                	jmp    1f <main+0x1f>
            for (z = 0; z < limit; z += 1)
  72:	d9 ee                	fldz   
  74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  78:	d8 05 ac 07 00 00    	fadds  0x7ac
  7e:	d9 05 b0 07 00 00    	flds   0x7b0
  84:	df e9                	fucomip %st(1),%st
  86:	77 f0                	ja     78 <main+0x78>
  88:	dd d8                	fstp   %st(0)
  8a:	eb c0                	jmp    4c <main+0x4c>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb b4 07 00 00       	mov    $0x7b4,%ebx
        while(*s != 0){
 ...
 611:	a1 64 0a 00 00       	mov    0xa64,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 64 0a 00 00       	mov    %eax,0xa64
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 767:	0a 00 00 
 76a:	c7 05 68 0a 00 00 68 	movl   $0xa68,0xa68
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 68 0a 00 00       	mov    $0xa68,%eax
 779:	c7 05 6c 0a 00 00 00 	movl   $0x0,0xa6c
 780:	00 00 00 
