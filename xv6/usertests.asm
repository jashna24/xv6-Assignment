    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  *lastaddr = 99;
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fbd:	6a 00                	push   $0x0
    2fbf:	e8 76 09 00 00       	call   393a <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    300a:	6a 00                	push   $0x0
    300c:	e8 29 09 00 00       	call   393a <sbrk>
    3011:	29 c3                	sub    %eax,%ebx
    3013:	89 1c 24             	mov    %ebx,(%esp)
    3016:	e8 1f 09 00 00       	call   393a <sbrk>
...
000035c0 <argptest>:
{
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35df:	6a 00                	push   $0x0
    35e1:	e8 54 03 00 00       	call   393a <sbrk>
...
000038ba <getpinfo>:
SYSCALL(getpinfo)
    38ba:	b8 18 00 00 00       	mov    $0x18,%eax
    38bf:	cd 40                	int    $0x40
    38c1:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cbe:	56                   	push   %esi
    3cbf:	e8 76 fc ff ff       	call   393a <sbrk>
  if(p == (char*)-1)
