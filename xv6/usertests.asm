...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    317e:	6a 00                	push   $0x0
    3180:	e8 bd 07 00 00       	call   3942 <sleep>
    sleep(0);
    3185:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    318c:	e8 b1 07 00 00       	call   3942 <sleep>
    kill(pid);
    ...
    3969:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
    ...
    39d0:	e8 f5 fe ff ff       	call   38ca <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3a40:	e8 85 fe ff ff       	call   38ca <write>
  ...
  write(fd, &c, 1);
    ...
    3aa1:	e8 24 fe ff ff       	call   38ca <write>
  ...
  write(fd, &c, 1);
    3aba:	e8 0b fe ff ff       	call   38ca <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3b53:	57                   	push   %edi
    3b54:	53                   	push   %ebx
    3b55:	e8 70 fd ff ff       	call   38ca <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3ba7:	e8 1e fd ff ff       	call   38ca <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cbe:	56                   	push   %esi
    3cbf:	e8 6e fc ff ff       	call   3932 <sbrk>
  if(p == (char*)-1)
