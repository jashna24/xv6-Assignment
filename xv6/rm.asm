...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 f0 02 00 00       	call   32a <unlink>
 ...
 198:	89 f3                	mov    %esi,%ebx
{
 ...
 1b0:	50                   	push   %eax
 1b1:	6a 00                	push   $0x0
 1b3:	e8 3a 01 00 00       	call   2f2 <read>
    if(cc < 1)
 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 400:	e8 f5 fe ff ff       	call   2fa <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 470:	e8 85 fe ff ff       	call   2fa <write>
 ...
 4d1:	e8 24 fe ff ff       	call   2fa <write>
 ...
 4e8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ea:	e8 0b fe ff ff       	call   2fa <write>
  for(i = 0; fmt[i]; i++){
 ...
 583:	57                   	push   %edi
 584:	53                   	push   %ebx
 585:	e8 70 fd ff ff       	call   2fa <write>
        while(*s != 0){
 ...
 5d7:	e8 1e fd ff ff       	call   2fa <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6ee:	56                   	push   %esi
 6ef:	e8 6e fc ff ff       	call   362 <sbrk>
  if(p == (char*)-1)
