 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3e0:	e8 05 ff ff ff       	call   2ea <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 450:	e8 95 fe ff ff       	call   2ea <write>
 ...
 4b1:	e8 34 fe ff ff       	call   2ea <write>
 ...
 4c8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ca:	e8 1b fe ff ff       	call   2ea <write>
  for(i = 0; fmt[i]; i++){
 ...
 563:	57                   	push   %edi
 564:	53                   	push   %ebx
 565:	e8 80 fd ff ff       	call   2ea <write>
        while(*s != 0){
 ...
 5b7:	e8 2e fd ff ff       	call   2ea <write>
        ap++;
