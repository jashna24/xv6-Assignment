 ...
 188:	89 f3                	mov    %esi,%ebx
{
 ...
 1a0:	50                   	push   %eax
 1a1:	6a 00                	push   $0x0
 1a3:	e8 3a 01 00 00       	call   2e2 <read>
    if(cc < 1)
 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3f0:	e8 f5 fe ff ff       	call   2ea <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 460:	e8 85 fe ff ff       	call   2ea <write>
 ...
 4c1:	e8 24 fe ff ff       	call   2ea <write>
 ...
 4d8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4da:	e8 0b fe ff ff       	call   2ea <write>
  for(i = 0; fmt[i]; i++){
 ...
 573:	57                   	push   %edi
 574:	53                   	push   %ebx
 575:	e8 70 fd ff ff       	call   2ea <write>
        while(*s != 0){
 ...
 5c7:	e8 1e fd ff ff       	call   2ea <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6de:	56                   	push   %esi
 6df:	e8 6e fc ff ff       	call   352 <sbrk>
  if(p == (char*)-1)
