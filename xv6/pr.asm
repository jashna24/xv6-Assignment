...
int main()
{
  ...
  11:	83 ec 28             	sub    $0x28,%esp
    int w,r,ret,p[4];
    if(fork()==0)
  14:	e8 31 03 00 00       	call   34a <fork>
  19:	85 c0                	test   %eax,%eax
  1b:	75 7e                	jne    9b <main+0x9b>
  1d:	8d 75 d8             	lea    -0x28(%ebp),%esi
  20:	8d 7d e8             	lea    -0x18(%ebp),%edi
  ...
  2a:	85 c0                	test   %eax,%eax
             p[i]=fork();
  2c:	89 06                	mov    %eax,(%esi)
            if(p[i]==0)
  2e:	0f 84 8f 00 00 00    	je     c3 <main+0xc3>
  ...
  3b:	bf 40 00 00 00       	mov    $0x40,%edi
            printf(1,"proc %d... pid %d\n",i,p[i]);
  40:	8b 74 9d d8          	mov    -0x28(%ebp,%ebx,4),%esi
  44:	56                   	push   %esi
  45:	53                   	push   %ebx
  46:	68 16 08 00 00       	push   $0x816
  4b:	6a 01                	push   $0x1
  ...
  5b:	50                   	push   %eax
  5c:	56                   	push   %esi
  5d:	e8 90 03 00 00       	call   3f2 <set_priority>
        for(int i=0;i<4;i++){
  62:	83 c4 10             	add    $0x10,%esp
  65:	83 fb 04             	cmp    $0x4,%ebx
  68:	75 d6                	jne    40 <main+0x40>
  6a:	8d 7d d4             	lea    -0x2c(%ebp),%edi
  6d:	8d 75 d0             	lea    -0x30(%ebp),%esi
        }
        for(int i=0; i<4;i++)
        {
  ...
  73:	57                   	push   %edi
  74:	56                   	push   %esi
  75:	e8 e8 02 00 00       	call   362 <waitx>
            printf(1,"pid-%d rtime-%d wtime-%d\n",ret,r,w);
  7a:	59                   	pop    %ecx
  7b:	ff 75 d0             	pushl  -0x30(%ebp)
  7e:	ff 75 d4             	pushl  -0x2c(%ebp)
  81:	50                   	push   %eax
  82:	68 29 08 00 00       	push   $0x829
  87:	6a 01                	push   $0x1
  ...
  94:	75 da                	jne    70 <main+0x70>
    ...
    exit();
  96:	e8 b7 02 00 00       	call   352 <exit>
    ret=waitx(&w,&r);
  9b:	50                   	push   %eax
  9c:	50                   	push   %eax
  9d:	8d 45 d4             	lea    -0x2c(%ebp),%eax
  a0:	50                   	push   %eax
  a1:	8d 45 d0             	lea    -0x30(%ebp),%eax
  a4:	50                   	push   %eax
  a5:	e8 b8 02 00 00       	call   362 <waitx>
    printf(1,"parent proc:- pid-%d rtime-%d wtime-%d\n",ret,w,r);
  aa:	5a                   	pop    %edx
  ab:	ff 75 d4             	pushl  -0x2c(%ebp)
  ae:	ff 75 d0             	pushl  -0x30(%ebp)
  b1:	50                   	push   %eax
  b2:	68 44 08 00 00       	push   $0x844
  b7:	6a 01                	push   $0x1
  b9:	e8 f2 03 00 00       	call   4b0 <printf>
    exit();
  be:	83 c4 20             	add    $0x20,%esp
  c1:	eb d3                	jmp    96 <main+0x96>
                printf(1,"proc %d.... \n",p[i]);
  c3:	51                   	push   %ecx
  c4:	6a 00                	push   $0x0
  c6:	bb 81 96 98 00       	mov    $0x989681,%ebx
  cb:	68 08 08 00 00       	push   $0x808
  d0:	6a 01                	push   $0x1
  d2:	e8 d9 03 00 00       	call   4b0 <printf>
  d7:	83 c4 10             	add    $0x10,%esp
  da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
                    printf(1,"");
  e0:	83 ec 08             	sub    $0x8,%esp
  e3:	68 15 08 00 00       	push   $0x815
  e8:	6a 01                	push   $0x1
 ...
 218:	89 f3                	mov    %esi,%ebx
{
 ...
 230:	50                   	push   %eax
 231:	6a 00                	push   $0x0
 233:	e8 42 01 00 00       	call   37a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 29d:	e8 00 01 00 00       	call   3a2 <open>
  if(fd < 0)
 ...
 2ba:	89 c6                	mov    %eax,%esi
  close(fd);
 2bc:	e8 c9 00 00 00       	call   38a <close>
  return r;
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 6c 08 00 00       	mov    $0x86c,%ebx
        while(*s != 0){
